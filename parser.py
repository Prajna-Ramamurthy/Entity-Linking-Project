...
true_positives = sum(1 for info in entities.values() if info["cui"] in gold_standard_cuis)
false_positives = len(entities) - true_positives
false_negatives = len(gold_standard_cuis) - true_positives
